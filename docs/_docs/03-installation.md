...
[<i class="fas fa-download"></i> Download Minimal Mistakes Theme](https://github.com/minimal-mistakes/minimal-mistakes/archive/master.zip){: .btn .btn--success}
...
**ProTip:** To be bleeding edge install the latest (unreleased) version of Minimal Mistakes by adding this line to your `Gemfile`: `gem "minimal-mistakes-jekyll", :github => "minimal-mistakes/minimal-mistakes"`.
{: .notice--info}
