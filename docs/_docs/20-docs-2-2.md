...
1. Fork the [Minimal Mistakes repo](http://github.com/minimal-mistakes/minimal-mistakes/fork).
...
1. [Download Minimal Mistakes](https://github.com/minimal-mistakes/minimal-mistakes/releases/tag/2.2.1) and unzip.
...
```yaml
url: http://minimal-mistakes.github.io/minimal-mistakes
...
- title: Made Mistakes
  url: http://https://minimal-mistakes.github.io/minimal-mistakes/
```
...
image:
  feature: feature-image-filename.jpg
  credit: Wayne Wesley #name of the person or site you want to credit
  creditlink: http://https://minimal-mistakes.github.io/minimal-mistakes/ #url to their site or licensing
```
